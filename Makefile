...
calistir_os_kernels: calistir_qemu_smoke calistir_kernel_dizi_bare_metal \
                     ...
                     calistir_tick_test_arm calistir_smp_test_arm calistir_smp_compute_test_arm calistir_smp_queue_test_arm calistir_smp_atomic_test_arm calistir_spawn_test_arm calistir_yasam_test_arm \
