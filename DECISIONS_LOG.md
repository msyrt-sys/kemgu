...
UYGULA kolu, CAGRI'da ERISIM kolu); `test/test_linear.c` (+7, 89→96; testler T90-T96 — T84-T89 D-320'nin);
`test/check_korpus/tc5g_01..07` (+7, 61→68).]**
D-323/D-325'te "ortak boşluk, parite bozuk değil" diye kapsam dışı bıraktığım kalem.
...
**Kapılar:** test_linear **96/96** (+7), checker_diff **68/68** (+7),
codegen_diff 106/106, **FIXPOINT** , tip_kontrol 189/189,
