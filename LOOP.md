...
## Sirada
- [ ] Aritmetik tasma davranisini KILITLE: `add/sub/mul` nsw/nuw yok, sarma tanimli ve -O0/-O2'de kararli. Fikstur + kapi ekle (dil degisikligi YOK, mevcut davranisi sabitle).
