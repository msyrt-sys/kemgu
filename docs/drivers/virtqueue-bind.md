...
- GUNCEL: C2.7 sonrasi hata payload'i `tam32` sentinel yerine `BagHatasi` cesit tipidir. `virtqueue_bagla` yetkiyi sahiplenip tek noktada iade eder ve basarida secilen `queue_num` degerini `sonuc<tam32, BagHatasi>` ile dondurur.
