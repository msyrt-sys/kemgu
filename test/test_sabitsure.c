 ...
 *   CT005 — SABITSURE_PRODUCER_ARITY   (sabitsure_olustur arg sayisi)
...
static void T3_tip_mantiksal(void) {
    int h = kontrol_main(
        ...
        " = sabits\xc3\xbc" "re_olustur(do\xc4\x9fru);");
...
static void T15_iken_sabitsure_kosul(void) {
    int h = kontrol_main(
        "    de\xc4\x9fi\xc5\x9fken k: sabits\xc3\xbc" "re<mant\xc4\xb1ksal>"
        " = sabits\xc3\xbc" "re_olustur(yanl\xc4\xb1\xc5\x9f);\n"
        "    iken k { }");
...
static void T27_wrap_kesirli_yasak(void) {
    int h = kontrol_main(
        ...
        " = sabits\xc3\xbc" "re_olustur(3.14);");
...
static void T29_wrap_metin_yasak(void) {
    int h = kontrol_main(
        ...
        " = sabits\xc3\xbc" "re_olustur(\"gizli\");");
...
static void T30_nesting_yasak(void) {
    int h = kontrol_main(
        ...
        "re<tam32>> = sabits\xc3\xbc" "re_olustur(5);");
...
static void T31_producer_zero_arg(void) {
    int h = kontrol_main(
        "    de\xc4\x9fi\xc5\x9fken k = sabits\xc3\xbc" "re_olustur();");
    test_sonuc("S9: sabitsure_olustur() (0 arg) -> CT005", h >= 1);
}

static void T32_producer_two_arg(void) {
    int h = kontrol_main(
        "    de\xc4\x9fi\xc5\x9fken k = sabits\xc3\xbc" "re_olustur(1, 2);");
    test_sonuc("S9: sabitsure_olustur(1,2) -> CT005", h >= 1);
}
